...
public class SingleMutationPrediction {
	public static void main(String[] args) {
		...
		char original = args[1].charAt(0);
		char mutated = args[2].charAt(0);
		String sequence = args[3];
		String agenda = args[4];
		...
		//RELOAD RBM FILES
		File file = new File("/var/www/html/dnpros/bin/modelW100,60,20.txt");
        Reader reader = null;
        ...
        file = new File("/var/www/html/dnpros/bin/modelB100,60,20.txt");
        Reader reader2 = null;
        try {
        ...
        //WRITE FILE
        try{
			FileWriter file1 = new FileWriter(agenda);
